...
void null_bvaction(struct prop_s *prop, const bv_t *bv);
void abstract_bvaction(struct prop_s *prop, const bv_t *bv);
void persistent_bvaction(struct prop_s *prop, const bv_t *bv);
void constant_bvaction(struct prop_s *prop, const bv_t *bv);
void volatile_bvaction(struct prop_s *prop, const bv_t *bv);
void et_boolean_bva(struct prop_s *prop, const bv_t *bv);
void et_sint_bva(struct prop_s *prop, const bv_t *bv);
void et_uint_bva(struct prop_s *prop, const bv_t *bv);
void et_float_bva(struct prop_s *prop, const bv_t *bv);
void et_UTF8_bva(struct prop_s *prop, const bv_t *bv);
void et_UTF16_bva(struct prop_s *prop, const bv_t *bv);
void et_UTF32_bva(struct prop_s *prop, const bv_t *bv);
void et_string_bva(struct prop_s *prop, const bv_t *bv);
void et_enum_bva(struct prop_s *prop, const bv_t *bv);
void et_opaque_fixsize_bva(struct prop_s *prop, const bv_t *bv);
void et_opaque_varsize_bva(struct prop_s *prop, const bv_t *bv);
void et_uuid_bva(struct prop_s *prop, const bv_t *bv);
void et_bitmap_bva(struct prop_s *prop, const bv_t *bv);
